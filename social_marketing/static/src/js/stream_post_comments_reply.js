...
export class StreamPostCommentsReply extends Component {
    ...
    async _addComment(textarea) {
        ...
        const formData = new FormData(
            textarea.closest(".o_social_marketing_write_reply").querySelector("form")
        );
     ...
     */
    _onAddImage(event) {
        event.currentTarget.closest(".o_social_marketing_write_reply").querySelector(".o_input_file").click();
    }
...
StreamPostCommentsReply.template = "social_marketing.StreamPostCommentsReply";
