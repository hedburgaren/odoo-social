...
import { SocialPostFormatterMixin } from './social_marketing_post_formatter_mixin';
...
//        this.rpc = useService('rpc');
    ...
    get bodyClass() {
        return 'o_social_marketing_comments_modal o_social_marketing_comments_modal_' + this.originalPost.media_type.raw_value + ' pt-0 px-0 bg-100';
    }
...
StreamPostComments.template = 'social_marketing.StreamPostComments';
