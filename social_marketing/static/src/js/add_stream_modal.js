...
export class AddSocialStreamDialog extends Component {
    ...
    _onClickSocialMedia(event) {
        ...
        this.orm.call('social_marketing.media', 'action_add_account', [mediaId], {
...
AddSocialStreamDialog.template = "social_marketing.AddSocialStreamDialog";
