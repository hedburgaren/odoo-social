...
//        this.user = useService('user');
        ...
        }, () => [document.querySelector('.o_social_marketing_js_add_stream')]);

        onWillStart(async () => {
            this.isSocialManager = await user.hasGroup("social_marketing.group_social_marketing_manager");
            this.hasAccounts = await this.orm.searchCount('social_marketing.account', []) > 0;
...
StreamPostKanbanController.template = 'social_marketing.SocialKanbanView';
