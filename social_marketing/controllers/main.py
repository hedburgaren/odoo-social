...
class SocialValidationException(Exception):
    ...
    def __init__(self, message, documentation_link=False, documentation_link_label=False,
                 documentation_link_icon_class=False):
...
class SocialController(http.Controller):
    ...
    def _get_social_marketing_stream_post(self, stream_post_id, media_type):
